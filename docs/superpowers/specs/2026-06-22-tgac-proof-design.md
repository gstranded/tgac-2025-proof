...
Create a public GitHub Pages site for `gstranded` that verifies and explains a Tencent Games Algorithm Competition 2025 certificate. The page must make the core claim visible immediately: the team won Second Place in the Data-Intelligence Decision Science track.
...
Use a small static GitHub Pages site hosted from `/docs` in a repository named `tgac-2025-proof`.
...
- Links section with:
  ...
  - Expected GitHub repository link: `https://github.com/gstranded/tgac-2025-proof`
