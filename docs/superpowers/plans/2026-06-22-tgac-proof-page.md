...
- Public proof URL: `https://gstranded.github.io/tgac-2025-proof/`
- Repository URL: `https://github.com/gstranded/tgac-2025-proof`
...
Run: `git remote add origin https://github.com/gstranded/tgac-2025-proof.git`
...
If Git asks for credentials, use username `gstranded` and a GitHub personal access token, not the account password.
